        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="err-handler">
                ...
                <form>
                    ...
                    <div>
                        <button class="but but-block but-blue" @click="submit()">Join
                        </button>
                    </div>
                </form>
            </div>
                ...
                <form>
                    ...
                    <div class="frm-group">
                        <label class="frm-input-label" for="bandName">Band Name
                            <input class="frm-input" type="text" placeholder="" id='bandName' v-model="bandName">
                        </label>
                    </div>
                    <div class="frm-group">
                        <label class="frm-input-label">Genre
                            <div class="row fix-row-genres">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-check-input" id="other" type="checkbox" v-model='genres' value="10">
                    ...
                    <div>
                        <button class="but but-block but-yellow" type='button' @click='submitNewBand'>Create Band
                        </button>
                    </div>
                </form>
            </div>
